...
@section('content')
    ...
    <div class="banner_men mt-5">
        <img class="img-fluid w-100" src="{{ asset('Banner/weddingbanner.png') }}" alt="">
    </div>
    {{-- Banner Ends --}}
    {{-- Content One --}}
    <div class="contentOne mt-5">
        ...
        {{-- Banner Starts --}}
        <div class="banner_men mt-5">
            <img class="img-fluid w-100" src="{{ asset('Banner/weddingbottombanner.png') }}" alt="">
        </div>
        {{-- Banner Ends --}}
    </div>
    {{-- Footer --}}
